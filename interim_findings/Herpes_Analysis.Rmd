...
circular codes for frame 0 = 172,173,23 
...
file172_0 = "output_sequences/Herpes/output_Herpes_X172_frame_0.fasta"
file173_0 = "output_sequences/Herpes/output_Herpes_X173_frame_0.fasta"
file23_0 = "output_sequences/Herpes/output_Herpes_X23_frame_0.fasta"

file191_1 = "output_sequences/Herpes/output_Herpes_X191_frame_1.fasta"
file42_1 = "output_sequences/Herpes/output_Herpes_X42_frame_1.fasta"
file126_1 = "output_sequences/Herpes/output_Herpes_X126_frame_1.fasta"
file23_1 = "output_sequences/Herpes/output_Herpes_X23_frame_1.fasta"

file210_2 = "output_sequences/Herpes/output_Herpes_X210_frame_2.fasta"
file89_2 = "output_sequences/Herpes/output_Herpes_X89_frame_2.fasta"
file88_2 = "output_sequences/Herpes/output_Herpes_X88_frame_2.fasta"
file23_2 = "output_sequences/Herpes/output_Herpes_X23_frame_2.fasta"
...
```{r}
ml23_0 = ccmotif.lengthslist(ff23_0, code23)
summary(ml23_0$incode)
ml172_0 = ccmotif.lengthslist(ff172_0, codes.c3[[172]])
summary(ml172_0$incode)
ml173_0 = ccmotif.lengthslist(ff173_0, codes.c3[[173]])
summary(ml173_0$incode)
```

```{r}
ml191_1 = ccmotif.lengthslist(ff191_1, codes.c3[[191]])
summary(ml191_1$incode)
ml42_1 = ccmotif.lengthslist(ff42_1, codes.c3[[42]])
summary(ml42_1$incode)
ml126_1 = ccmotif.lengthslist(ff126_1, codes.c3[[126]])
summary(ml126_1$incode)
ml23_1 = ccmotif.lengthslist(ff23_1, codes.c3[[23]])
summary(ml23_1$incode)
```

```{r}
ml210_2 = ccmotif.lengthslist(ff210_2, codes.c3[[210]])
summary(ml210_2$incode)
ml89_2 = ccmotif.lengthslist(ff89_2, codes.c3[[89]])
summary(ml89_2$incode)
ml88_2 = ccmotif.lengthslist(ff88_2, codes.c3[[88]])
summary(ml88_2$incode)
ml23_2 = ccmotif.lengthslist(ff23_2, codes.c3[[23]])
summary(ml23_2$incode)
```

Average non-motif length:
```{r echo=FALSE}
summary(ml23_0$outcode)
summary(ml172_0$outcode)
summary(ml173_0$outcode)
```

```{r}
summary(ml191_1$outcode)
summary(ml42_1$outcode)
summary(ml126_1$outcode)
summary(ml23_1$outcode)
```

```{r}
summary(ml210_2$outcode)
summary(ml89_2$outcode)
summary(ml88_2$outcode)
summary(ml23_2$outcode)
```

Motif length distribution: theoretical distribution (red) copared with the sample (blue):
```{r echo=FALSE}
r23_0 = ccmotif.classes(ml23_0$incode, p23_0, K = 18)
ccmotif.barplotDiff(r23_0$sample, r23_0$geom, codeid = "Herpes - X23 Frame 0")

r172_0 = ccmotif.classes(ml172_0$incode, p172_0, K = 18)
ccmotif.barplotDiff(r172_0$sample, r172_0$geom, codeid = "Herpes - X172 Frame 0")

r173_0 = ccmotif.classes(ml173_0$incode, p173_0, K = 18)
ccmotif.barplotDiff(r173_0$sample, r173_0$geom, codeid = "Herpes - X173 Frame 0")


r191_1 = ccmotif.classes(ml191_1$incode, p191_1, K = 18)
ccmotif.barplotDiff(r191_1$sample, r191_1$geom, codeid = "Herpes - X191 Frame 1")

r42_1 = ccmotif.classes(ml42_1$incode, p42_1, K = 18)
ccmotif.barplotDiff(r42_1$sample, r42_1$geom, codeid = "Herpes - X42 Frame 1")

r126_1 = ccmotif.classes(ml126_1$incode, p126_1, K = 18)
ccmotif.barplotDiff(r126_1$sample, r126_1$geom, codeid = "Herpes - X126 Frame 1")

r23_1 = ccmotif.classes(ml23_1$incode, p23_1, K = 18)
ccmotif.barplotDiff(r23_1$sample, r23_1$geom, codeid = "Herpes - X23 Frame 1")


r210_2 = ccmotif.classes(ml210_2$incode, p210_2, K = 18)
ccmotif.barplotDiff(r210_2$sample, r210_2$geom, codeid = "Herpes - X210 Frame 2")

r89_2 = ccmotif.classes(ml89_2$incode, p89_2, K = 18)
ccmotif.barplotDiff(r89_2$sample, r89_2$geom, codeid = "Herpes - X89 Frame 2")

r88_2 = ccmotif.classes(ml88_2$incode, p88_2, K = 18)
ccmotif.barplotDiff(r88_2$sample, r88_2$geom, codeid = "Herpes - X88 Frame 2")

r23_2 = ccmotif.classes(ml23_2$incode, p23_2, K = 18)
ccmotif.barplotDiff(r23_2$sample, r23_2$geom, codeid = "Herpes - X23 Frame 2")
```

Expected mean value of the motif length vs real mean value:
```{r echo=FALSE}
E23_0 = function(p23_0) 1 / (1 - p23_0)
mmt23_0 = E23_0(p23_0)
mm23_0 = mean(ml23_0$incode)
round(c(sample = mm23_0, expected = mmt23_0), digits = 2)

E172_0 = function(p172_0) 1 / (1 - p172_0)
mmt172_0 = E172_0(p172_0)
mm172_0 = mean(ml172_0$incode)
round(c(sample = mm172_0, expected = mmt172_0), digits = 2)

E173_0 = function(p173_0) 1 / (1 - p173_0)
mmt173_0 = E173_0(p173_0)
mm173_0 = mean(ml173_0$incode)
round(c(sample = mm173_0, expected = mmt173_0), digits = 2)

```

```{r}

E191_1 = function(p191_1) 1 / (1 - p191_1)
mmt191_1 = E191_1(p191_1)
mm191_1 = mean(ml191_1$incode)
round(c(sample = mm191_1, expected = mmt191_1), digits = 2)

E42_1 = function(p42_1) 1 / (1 - p42_1)
mmt42_1 = E42_1(p42_1)
mm42_1 = mean(ml42_1$incode)
round(c(sample = mm42_1, expected = mmt42_1), digits = 2)

E126_1 = function(p126_1) 1 / (1 - p126_1)
mmt126_1 = E126_1(p126_1)
mm126_1 = mean(ml126_1$incode)
round(c(sample = mm126_1, expected = mmt126_1), digits = 2)

E23_1 = function(p23_1) 1 / (1 - p23_1)
mmt23_1 = E23_1(p23_1)
mm23_1 = mean(ml23_1$incode)
round(c(sample = mm23_1, expected = mmt23_1), digits = 2)

```

```{r}

E210_2 = function(p210_2) 1 / (1 - p210_2)
mmt210_2 = E210_2(p210_2)
mm210_2 = mean(ml210_2$incode)
round(c(sample = mm210_2, expected = mmt210_2), digits = 2)

E89_2 = function(p89_2) 1 / (1 - p89_2)
mmt89_2 = E89_2(p89_2)
mm89_2 = mean(ml89_2$incode)
round(c(sample = mm89_2, expected = mmt89_2), digits = 2)

E88_2 = function(p88_2) 1 / (1 - p88_2)
mmt88_2 = E88_2(p88_2)
mm88_2 = mean(ml88_2$incode)
round(c(sample = mm88_2, expected = mmt88_2), digits = 2)

E23_2 = function(p23_2) 1 / (1 - p23_2)
mmt23_2 = E23_2(p23_2)
mm23_2 = mean(ml23_2$incode)
round(c(sample = mm23_2, expected = mmt23_2), digits = 2)
```
