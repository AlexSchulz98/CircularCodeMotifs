...
Which leads to this score for following sequences:
```{r}
val23_0 = valueTable(rds23_0, code23,p23_0)
round(val23_0,2)

val172_0 = valueTable(rds172_0, codes.c3[[172]],p172_0)
val173_0 = valueTable(rds173_0, codes.c3[[173]],p173_0)

val191_1 = valueTable(rds191_1, codes.c3[[191]],p191_1)
val42_1 = valueTable(rds42_1, codes.c3[[42]],p42_1)
val126_1 = valueTable(rds126_1, codes.c3[[126]],p126_1)

val23_1 = valueTable(rds23_1, code23,p23_1)
round(val23_1,2)

val210_2 = valueTable(rds210_2, codes.c3[[210]],p210_2)
val89_2 = valueTable(rds89_2, codes.c3[[89]],p89_2)
val88_2 = valueTable(rds88_2, codes.c3[[88]],p88_2)

val23_2 = valueTable(rds23_2, code23,p23_2)
round(val23_2,2)
```
...
c_score = c(round(val23_0,2),round(val172_0,2),round(val173_0,2),
            round(val191_1,2),round(val42_1,2),round(val126_1,2),round(val23_1,2),
            round(val210_2,2),round(val89_2,2),round(val88_2,2),round(val23_2,2))
a_score = c()
score = c()
...
df = data.frame(changed,ch,not_changed,not_ch,not_possible,not_p,not_needed,not_n,c_score,
                row.names = rows)
