...
names(df) = c("Organism","Code","Contains Stop-Codons?","Frame","Achieved Code Usage","% of Codons changed","Sample Mean Motif Lenght","Expected Mean Motif Lenght","Diff","Max. Motif Length","Edit Score","Edit Distance")
...
```{r}
date = Sys.Date()
write.xlsx(df, file = "Summary_Analysis.xlsx",
      sheetName = toString(date), append = TRUE)
```
