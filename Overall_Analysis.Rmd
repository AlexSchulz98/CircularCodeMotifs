...
names(df) = c("Organism","Code","Stop-Codons in Code?","Frame","Achieved Code Usage","% of Codons changed","Sample Mean Motif Lenght","Expected Mean Motif Lenght","Diff","Max. Motif Length","Edit Score","Edit Distance")
...
write.xlsx(df, file = "analysis_results/Summary_Analysis.xlsx",
      sheetName = "complete", append = TRUE)
```
