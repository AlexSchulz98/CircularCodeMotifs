...
#' @return
#' @export
ccmotif.readCodes = function(filename, tupleSize = 3, 
...
#'
#' @export
ccmotif.writeCodes = function(filename, codes) {
  header = "# codes"
...
#' @export
codes.c3 = {
  ccmotif.readCodes("ccmotif/data/C3-self-compl-circ-codes.txt",
...
#' @param uracil If false, all Us are replaced by Ts.
#'
...
#' @param species A labe for a species.
